...
\begin{document}
    ...
    This works well for many of today's workloads. This current system has the benefits of decades of optimizations
    ...
    This is where FPGAs enter the picture. Less powerfull FPGAs are cheap and widely available. FPGAs themselves
    are often used to prototype ASICs. However they can also be used to implement algorithms were precise control
    ...
    it simply has wires on a circuit.
    ...
    concepts to create advances FPGA projects.
