...
\begin{document}
    ...
    Just this brute force approach will not work for RNGs like the one used
    in PHP's standard library [todo cite this] due to it using 64 bit values.
    ...
    the remaining bits could possibly be guessed through a brute force approach.
