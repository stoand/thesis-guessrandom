...
\begin{document}
    ...
    Namely, PLAs were generally must faster than PROMs. They could also support a far
    ...
    This system proved to be every effective throughout the war.
    ...
    In 80's there were a number implementations like the one proposed by Maryanski as well
...
`endif
    ...
    but they could rent FPGAs in the cloud from cloud providers like Amazon.
